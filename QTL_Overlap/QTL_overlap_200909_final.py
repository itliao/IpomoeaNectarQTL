...
peakG = pd.read_csv("200817_RQTL2/GenoPheno_Merge_LOCO1g_qtlCon_200902.txt", sep="\t",engine='python') 
peakC = pd.read_csv("200817_RQTL2/GenoPhenoMeanLOD_PVE_PDE_Geno_2c05_200901.csv", sep=",",engine='python') 
